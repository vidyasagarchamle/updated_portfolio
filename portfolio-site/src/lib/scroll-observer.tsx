...
export function ScrollObserverProvider({ children }: ScrollObserverProviderProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      sections.forEach((rect, id) => {
        ...
        const distanceFromViewportMiddle = Math.abs(currentScrollY + window.innerHeight / 2 - sectionMiddle)
