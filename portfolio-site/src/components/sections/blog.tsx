...
const blogPosts = [
  {
    ...
    description: "How sovereign AI agents functioning on blockchain networks could revolutionize digital economies and create new value paradigms.",
    date: "Mar 12, 2024",
    readTime: "6 min read",
    ...
    image: "https://miro.medium.com/v2/resize:fit:720/format:webp/1*q1BCyzsLpmF8aY58-WUG-A.jpeg"
  },
  {
    id: 2,
    title: "Uncovering First Principles: My Insights Into Understanding Core Consumer Behavior",
    description: "A framework for breaking down consumer behaviors to their fundamental drivers, focusing on first-principles thinking.",
    date: "Jun 16, 2023",
    readTime: "4 min read",
    ...
    image: "https://miro.medium.com/v2/resize:fit:720/format:webp/1*GVBF0zLikpU7qPpf0Qw01A.jpeg"
  },
  {
    id: 3,
    title: "Charlie Munger: \"The World is Driven by Envy, Not Greed\"",
    description: "Reflecting on Munger's insights about envy as a stronger motivator than greed, and its implications for product design.",
    date: "Jun 16, 2023",
    readTime: "3 min read",
    ...
    image: "https://miro.medium.com/v2/resize:fit:720/format:webp/1*Tq_NVRU3FxaWPIe09j6mRw.jpeg"
  },
]
...
export function Blog() {
  return (
    <section id="blog" className="py-16 md:py-24 bg-background dark:bg-black/10 overflow-hidden relative">
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl font-bold md:text-5xl text-balance mb-4">
            Recent <span className="bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent dark:from-purple-300 dark:to-purple-500">Articles</span>
          </h2>
          <p className="text-foreground/70 dark:text-foreground/60 max-w-xl mx-auto leading-relaxed">
            Thoughts on product management, blockchain, AI, and the future of technology.
          </p>
        </motion.div>
              ...
              <Card className="h-full flex flex-col transition-all duration-300 hover:shadow-lg hover:translate-y-[-2px] bg-card dark:bg-card/80 backdrop-blur-sm overflow-hidden border border-border/30 dark:border-border/20 rounded-xl">
                <CardHeader className="pb-2 pt-5">
                  ...
                  <CardTitle className="text-xl hover:text-primary transition-colors mb-1">
                    <a href={post.url} target="_blank" rel="noopener noreferrer" className="hover:underline decoration-primary/30 underline-offset-4">
                      {post.title}
                    </a>
                  </CardTitle>
                </CardHeader>
                <CardContent className="pb-2">
                  <div className="flex flex-wrap gap-1.5">
                    {post.tags.map((tag) => (
                      <Badge key={tag} variant="secondary" className="rounded-full px-3 py-1 bg-muted/60 dark:bg-muted/40 text-foreground/80 dark:text-foreground/70 text-xs font-medium">
                        {tag}
                      </Badge>
                    ))}
                  </div>
                ...
                <CardFooter className="pt-2 pb-5 mt-auto">
                  <Button variant="outline" className="w-full justify-between font-medium text-primary dark:text-primary/90 hover:bg-primary/5 dark:hover:bg-primary/10 border-primary/10 dark:border-primary/20 hover:border-primary/30 rounded-lg" asChild>
        ...
        <div className="mt-12 text-center">
          <Button 
            ...
            asChild
          >
            <a href="https://medium.com/@vidyasagar.chamle" target="_blank" rel="noopener noreferrer" className="flex items-center">
