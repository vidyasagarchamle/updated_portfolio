...
const caseStudies = [
  {
    ...
    description: "Comprehensive analysis of DAU optimization, payer conversion, KPI-driven product optimization, and cross-functional collaboration.",
    parts: [
      "DAU Optimization",
      "Payer Conversion",
...
export function CaseStudies() {
  return (
    <section id="case-studies" className="py-16 md:py-20 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl font-bold md:text-5xl text-balance mb-4">
            <span className="bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent">Solving</span> Product Challenges
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-5 max-w-7xl mx-auto">
          {caseStudies.map((study, index) => {
            ...
            const randomHeight = index % 3 === 0 ? 'min-h-[16rem]' : 'min-h-[15rem]';
            return (
              <motion.div
                key={study.id}
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-4">
                      <div className={cn(
                        ...
                        study.color === "purple" ? "bg-purple-500/20" :
                        study.color === "blue" ? "bg-blue-500/20" :
                        study.color === "green" ? "bg-green-500/20" :
                        study.color === "orange" ? "bg-orange-500/20" :
                        "bg-pink-500/20"
                      )}>
                        {study.icon}
                      </div>
