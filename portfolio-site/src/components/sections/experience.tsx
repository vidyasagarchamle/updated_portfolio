...
const experiences = [
  {
    ...
    summary: "A Telegram-based Web3 mini-game that introduced casual players to crypto gaming through simple, viral mechanics.",
    achievements: [
  ...
  },
  {
    ...
    summary: "A SaaS platform for sports tournament organizers, with a companion app to streamline player participation.",
    achievements: [
  ...
  },
  {
    ...
    summary: "A GameFi platform built on Algorand offering PvP, fantasy, and hypercasual games with real rewards.",
    achievements: [
  ...
  },
  {
    ...
    summary: "A mobile learning and engagement app for India's frontline retail workforce.",
    achievements: [
      ...
      <div className="container max-w-6xl relative z-10">
            ...
            <div key={exp.id} className="group h-full">
              <div className="h-full">
                ...
                >
                  ...
                  <div className={`relative h-full flex flex-col rounded-xl border ${exp.borderColor} ${exp.bgGradient} backdrop-blur-sm p-6 shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:translate-y-[-2px] group-hover:border-opacity-50`}>
                    {/* Top section with company and role */}
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-start gap-3">
                        <div className={`flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br ${exp.color} shadow-sm`}>
                        ...
                        <div>
                          ...
                          <p className="text-foreground/60 font-medium">{exp.position}</p>
                        </div>
                      </div>
                    ...
                    {/* Summary line */}
                    <div className="mb-4">
                      <p className="text-foreground/90 font-medium">{exp.summary}</p>
                    </div>
                    ...
                    <div className="space-y-2 flex-grow">
                      {exp.achievements.map((achievement, i) => (
                        <div key={i} className="flex items-start gap-2">
                          <div className={`h-5 w-5 flex-shrink-0 flex items-center justify-center rounded-full ${exp.iconColor} bg-primary/5 mt-0.5`}>
        ...
        <div className="mt-16 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <a href="#skills" className="inline-flex items-center gap-2 py-2 px-4 rounded-full text-primary bg-primary/5 hover:bg-primary/10 transition-colors group">
