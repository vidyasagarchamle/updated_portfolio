...
const skillCategories: SkillCategory[] = [
  {
    ...
    description: "Strategy, discovery, and execution across end-to-end product lifecycle.",
    skills: [
      "Product Strategy",
  ...
  },
  {
    ...
    description: "Designing, scaling, and managing Web3-native products and economies.",
    skills: [
  ...
  },
  {
    ...
    description: "Leveraging AI tools, workflows, and agents to ship smarter products faster.",
    skills: [
  ...
  },
  {
    ...
    description: "Daily stack for PM workflows, design, analytics, and async ops.",
    skills: [
      "Figma / FigJam",
      "Notion & Confluence",
      "JIRA / Trello / Linear",
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="text-foreground/70 max-w-xl mx-auto text-sm md:text-base">
            My expertise spans product management, web3, AI, and technical skills that help me build exceptional products.
          </p>
        </motion.div>
            ...
            {skillCategories.map((category) => (
              <TabsContent key={category.id} value={category.id} className="animate-in fade-in-50 duration-300">
                <Card className="border border-border/40 bg-background/50 dark:bg-background/20 backdrop-blur-sm overflow-hidden">
                  <div className={`absolute inset-0 bg-gradient-to-br ${category.color} opacity-30 dark:opacity-20`}></div>
                    ...
                    <div className="mb-4 md:mb-5 flex flex-col md:flex-row md:items-center md:justify-between">
                      <div className="flex items-center gap-3 mb-2 md:mb-0">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground dark:text-foreground/70">{category.description}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                      {category.skills.map((skill, i) => (
                        ...
                        >
                          ...
                          <span className="text-foreground/90 dark:text-foreground/80 text-sm">{skill}</span>
                        </div>
                      ))}
                    </div>
                  </CardContent>
